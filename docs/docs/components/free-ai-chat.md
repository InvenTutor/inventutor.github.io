...
Import the Custom Block from [above](free-ai-chat.md#custom-blocks), [activate it](../docs/how-to-activate-disabled-components.md), and then go to the `Send Network Request` block and replace `12345` in the Header with your own API Key.
